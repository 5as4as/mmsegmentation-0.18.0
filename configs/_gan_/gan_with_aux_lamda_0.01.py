_base_ = [
    '../_base_/datasets/gan_dataset.py',
...
train_cfg = dict(_delete_=True, lamda=0.01, lamda_aux=0.002)
...
evaluation = dict(interval=999000, metric='mIoU', by_epoch=False)

checkpoint_config = dict(interval=2000, by_epoch=False)

total_iters = 20000

load_generator = 'work_dirs/upernet_swin_tiny_patch4_window7_512x512_40k_refuge_pretrain_224x224_1K_add0_512x512_sigmoid_ce_2/iter_40000.pth'
