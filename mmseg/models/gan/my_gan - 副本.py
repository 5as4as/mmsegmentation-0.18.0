...
class MyGAN(BaseGAN):
    ...
    def train_step(self,
        ...
        img_s, gt_seg, img_metas_s = data_source['img'], data_source['gt_semantic_seg'], data_source['img_metas']
        img_t, img_metas_t = data_target['img'], data_target['img_metas']
        ...
        target_seg = self.generator(img_t, img_metas_t, return_loss=False, with_auxiliary_head=with_auxiliary_head, source=self.source)
        ...
        source_seg = self.generator(img_s, img_metas_s, return_loss=True, with_auxiliary_head=with_auxiliary_head, source=self.source)
        ...
        with torch.no_grad():
            ...
            pred_s = self.generator(img_s, img_metas_s, return_loss=False, with_auxiliary_head=with_auxiliary_head, source=self.source)
            pred_t = self.generator(img_t, img_metas_t, return_loss=False, with_auxiliary_head=with_auxiliary_head, source=self.source)
